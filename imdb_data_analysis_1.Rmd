...
ggplot(df_plot, aes(x = total_seasons, y = averageRating, size = numVotes, fill = numVotes)) +
  geom_jitter(aes(shape = "TV Series"), color = "black", alpha = 0.8, width = .2) +
  scale_shape_manual(values = 21, name = NULL, labels = "Each bubble is a TV series") +
  ...
  guides(
    size = guide_legend(override.aes = list(fill = "gray")),
